                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p>Инструмент преднозначен для автоматической проверки корректности переноса сайта с
                                        ...
                                        <p>
                                            Какие данные нужны
                                            <ul>
                                                <li>1. Необходимо что бы одновременно были доступны из интернета версия сайта после переноса и версия сайта до переноса.</li>
                                                <li>2. Делаем Список ссылок со старой версии сайта в виде показанном слева. А домен подставляем у этих ссылок тот где сейчас лежит сайт новой версии. Сделать можно, например, через XENU и заливаем их в проверяльщик.</li>
                                                <li>3. Указываем домен старого сайта в настройках.</li>
                                            </ul>
                                        </p>
                                        <p>
                                        Как это работает<br/>
                                        Проверяльщик смотрит есть ли по адресам указанных в файле загруженном в систему страницы на новой версии сайта. Если есть, то проверяет соответствие выбранных параметров (title, h1, text) на сайте который указав в качестве старого сайта. Если страница на новом сайте доступна через 301 редирект по ссылке старого сайта, то проверялщик корректно проверит ее параметры.
                                        </p>
                                    </div>
                                </div>
